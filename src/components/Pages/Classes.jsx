...
export default function Classes() {
    ...
    var [Temp3, setTemp3] = useState(0); //110
    var [count182, setcount182] = useState(0); //182
    var [count282, setcount282] = useState(0); //282
    var [count333, setcount333] = useState(0); //333
    var [count380, setcount380] = useState(0); //380
    var [count482, setcount482] = useState(0); //482
    var [count490, setcount490] = useState(0); //490
